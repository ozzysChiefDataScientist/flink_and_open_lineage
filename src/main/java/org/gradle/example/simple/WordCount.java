...
import org.gradle.example.simple.util.WordCountData;
import org.gradle.example.simple.util.CLI;
                ...
                ol.newOutputDatasetBuilder()
                    ...
                    .outputFacets(
                        ol.newOutputDatasetOutputFacetsBuilder()
                            .outputStatistics(ol.newOutputStatisticsOutputDatasetFacet(10L, 20L, 20L))
                            .build())
                    .build());
